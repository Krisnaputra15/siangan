...
<body class="flex flex-row">
    <nav class="w-[18%] bg-sky-950 h-screen sticky top-0">
        <div class="header flex items-center justify-center">
            <a href="{{route('sarpra.riwayat.index')}}" class="text-center text-white text-2xl font-semibold py-8 w-[85%] border-b-2 border-white">SIANGAN FILKOM</a>
        </div>
        <div class="menu">
            <ul class="py-8 ps-6">
                    <li class="py-2 text-white font-light"><a href="{{route('sarpra.riwayat.index')}}"><i class="fa-solid fa-clock-rotate-left mr-3"></i>Riwayat Peminjaman</a></li>
